            ...
            <Card>
              ...
              <div className="mt-4 flex gap-3">
                ...
                {item.stock !== undefined && item.stock > 5 && (
                  <div className="absolute top-[2px] right-[2px] bg-green-600 text-white text-xs px-2 py-0.5 rounded">
                    In stock
                  </div>
                )}
                {item.stock !== undefined &&
                  item.stock < 5 &&
                  item.stock > 0 && (
                    <div className="absolute top-[2px] right-[2px] bg-red-600 text-white text-xs px-2 py-0.5 rounded">
                      Low stock
                    </div>
                  )}
                {item.stock === 0 && (
