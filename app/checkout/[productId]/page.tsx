...
import { submitOrderAction, getProductById } from "@/lib/actions";
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between bg-neutral-900 rounded p-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-neutral-400">
                      1 × KSh {product.price.toLocaleString()}
                    </p>
                  </div>
                </div>
